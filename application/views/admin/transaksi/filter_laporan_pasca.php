        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <div class="page-header-title">
              <h5 class="m-b-10">Halaman Laporan Transaksi Pascabayar</h5>
            </div>
            <ul class="breadcrumb">
              <?php
              if ($akses['akses'] == 0) {
              ...
              <?php }
              ?>
              <li class="breadcrumb-item"><a href="#!">Tabel Data Laporan Transaksi Pascabayar</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-xl-12 col-md-12">
        <div class="card table-card">
          <div class="card-header">
            <h6><strong>Data Transaksi Pascabayar</strong></h6>
          ...
          <div class="card-body p-2">
            <div class="table-responsive">
              <form action="<?= base_url() ?>Admin/filter_laporan_pasca" method="POST">
                <div class="form-group row">
                  <div class="col-md-3">
                    <label for="mulai">Mulai Filter Cetak</label>
                    <input type="date" class="form-control" name="mulai" value="<?= $mulai ?>" id="mulai" required>
                  </div>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <select name="id_kios" class="form-control" id="kios">
                      <?php
                      $d_kios = $this->db->get_where('t_kios', ['id_kios' => $id_kios])->row_array();
                      if ($id_kios == '-Pilih Kios-') {
                        echo "<option>-Pilih Kios-</option>";
                      } else {
                        echo "
                        <option values='$d_kios[id_kios]'>$d_kios[nama_kios]</option>
              ...
              <div class="row">
                <div class="col-md-12">
                  <a href="<?= base_url() ?>Admin/cetak_laporan_pasca/<?= $mulai ?>/<?= $selesai ?>/<?= $id_kios ?>" class="btn btn-success btn-block" target="_blank"><i class="fas fa-print"></i> Cetak</a>
                </div>
              </div>
              <hr>
