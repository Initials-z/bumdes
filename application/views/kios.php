                ...
                <div class="col-lg-12 col-md-7 bg-white">
                    <div class="p-3">
                        <div class="text-center">
                            <img src="<?= base_url() ?>gambar/my2.png" width="280px" alt="wrapkit">
                        </div>
                        <form class="mt-4" action="<?= base_url() ?>Welcome/login_kios_pos" method="POST">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="kode">Kode Kios</label>
                                        <input class="form-control" id="kode" name="username" type="text" placeholder="Masukkan Kode Kios Anda">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
