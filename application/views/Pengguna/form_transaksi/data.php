        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <div class="page-header-title">
              <h5 class="m-b-10">Pembelian Paket Data</h5>
            </div>
            <ul class="breadcrumb">
              <li class="breadcrumb-item"><a href="<?= base_url() ?>Pengguna"><i class="feather icon-home"></i></a></li>
              <li class="breadcrumb-item"><a href="#!">Pembelian Paket Data</a></li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <form action="<?= base_url() ?>Transaksi/e_money_proses" id="myform" method="POST">
              ...
              <div class="form-group row">
                <div class="col-md-11" align="right">
                  ...
                  <a href="<?= base_url() ?>Pengguna/paket" class="btn btn-danger"><i class="fas fa-times"></i> Kembali</a>
                </div>
              </div>
            </form>
            <center>
