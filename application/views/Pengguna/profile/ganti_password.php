      ...
      <div class="col-xl-12 col-md-12">
        <div class="card table-card">
          ...
          <div class="card-body p-2">
            <form action="<?= base_url() ?>Pengguna/ganti_password_proses/<?= $akses['id_user'] ?>" method="post">
              ...
              <div class="form-group row">
                <div class="col-md-12" align="right">
                  <button type="submit" class="btn btn-primary"><i class="fas fa-floppy-o"></i> Simpan Perubahan</button>
                  <a href="<?= base_url() ?>Admin/profile" class="btn btn-danger"><i class="fas fa-close"></i> Batal</a>
                </div>
              </div>
            </form>
            <center>
