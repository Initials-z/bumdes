                    ...
                    <div class="col-md-2 text-center" align="right">
                      ...
                      if ($saldo['jumlah_saldo'] > $harga['harga']) {
                        ...
                        <?php } else { ?>
                          ...
                          <a href="<?= base_url() ?>Transaksi/e_money/<?= $al->buyer_sku_code ?>/<?= $harga['harga'] ?>/<?= $al->product_name ?>" class="btn btn-info btn-block" style="border-radius: 7px;padding:5px;">Beli</a>
                        <?php }
                      } else { ?>
