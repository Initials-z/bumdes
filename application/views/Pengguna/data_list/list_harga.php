                    ...
                    <div class="col-md-2 text-center" align="right">
                      ...
                      ?>
                        ...
                        <?php } else { ?>
                          ...
                          <a href="<?= base_url() ?>Transaksi/pulsa/<?= $al->buyer_sku_code ?>/<?= $harga['harga'] ?>/<?= $al->product_name ?>" class="btn btn-info btn-block" style="border-radius: 7px;padding:5px;">Beli</a>
                        <?php }
                      } else { ?>
                        <h6 class="text-muted m-b-10" style="color:red;margin-top:20px;"><i>*Saldo tidak mencukupi</i></h6>
                      <?php } ?>
                    </div>
                  </div>
                </div>
